...
class Manager:
    ...
    def get_child_tags(self, parent, text):
        for tag in parent.find_all(recursive=False):
            ...
            if self.reference.get(tag.name) and to_add not in text[self.reference[tag.name]]:
    ...
    def runtime(self, args):
        ...
        # ファイルの作成
        filename = Hash(self.result['title']).get_hash()
...
if __name__ == '__main__':
    ...
    urls = ['https://cookpad.com/recipe/2312038', 'https://cookpad.com/recipe/5254459']
